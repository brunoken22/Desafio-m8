...
export  function Home (){
   ...
   return (
      <div className={`container text-center ${css.contenedor}`}>
         <img src={img} alt="Pet Finder" style={{minWidth:"150px",maxWidth:"auto",height:"auto"}} />
         <Text long={true} eti="h2">Pet Finder</Text>
         <Text long={true}>Encontrá y reportá mascotas perdidas cerca de tu ubicación</Text>
         <div className={css.botones}>
            <Button btn="is-success" coordenadas={handleCoor} >Dar mi ubicación actual</Button>
