         ...
         <form className="formulario" onSubmit={handleSubmit}>
            <div className="report__form">
               <div className="mb-3">
                  ...
                  <input type="text" className="input form-control name-input" id="name" defaultValue ={pet.name} placeholder="Bobby" required/>
               </div>
               <div className={css.img}>   
                  <div className="button is-link is-light" aria-required  ref={subirFoto}>Subir Foto</div>
                     <div className="text-center">
                        <img src={pet.img} alt="" width="180px" height="175px"  ref={foto}  />
                     </div>
                  </div>
