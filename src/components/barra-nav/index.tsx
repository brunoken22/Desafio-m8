   ...
   return (
    <>
      ...
      <div className="navbar-brand">
         ...
         <a href="#" onClick={handleToogle} ref={burger} role="button" className="navbar-burger"  aria-label="menu" aria-expanded="false" data-target="navbarBasicExample">
      ...
      <div className= {`navbar-start ${css.start}`} >
         ...
         <div  className={css.cerrar} style={{display:"none",justifyContent: "center",alignItems: "center"}} ref={cerrarLogin}>
            <a className="btn-cerrar button is-danger is-rounded"  onClick={handleCerrarSesion}>Cerrar Sesión </a>
         </div>
      </div>
      </nav>
    </>
